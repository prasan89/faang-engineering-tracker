...
CREATE TABLE IF NOT EXISTS learning_goal (
    ...
    target_outcome VARCHAR(500) NOT NULL,
    deadline DATE,
...
CREATE TABLE IF NOT EXISTS learning_journal (
    ...
    built VARCHAR(2000),
    difficult VARCHAR(2000),
    revisit VARCHAR(2000),
    resources VARCHAR(3000),
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS learning_review (
    ...
    source_type VARCHAR(30) NOT NULL DEFAULT 'JOURNAL',
    source_id BIGINT,
